...
replace github.com/opencontainers/runc => github.com/opencontainers/runc v1.1.4 // Use the same version as Nomad.
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20221026175029-039d70eeef58
